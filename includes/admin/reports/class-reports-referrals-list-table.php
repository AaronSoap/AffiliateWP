...
/**
 * AffWP_Reports_Referrals_List_Table class.
 * Renders the Referrals table in the Reports screen.
 */
class AffWP_Reports_Referrals_List_Table extends WP_List_Table {
